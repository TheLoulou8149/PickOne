...
const styles = StyleSheet.create({
  ...
  cardSelected: { borderColor: Colors.primary + '60', backgroundColor: Colors.primaryPale },
  ...
  optionChipWinner: { borderColor: Colors.primary + '60', backgroundColor: Colors.primaryPale },
